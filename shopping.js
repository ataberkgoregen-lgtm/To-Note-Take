...
function loadItems() {
  ...
  //     {id:2, name: "Balik", completed: false},
  ...
  for (let item of items) {
    ...
    shoppingList.appendChild(li); //appendchild bizde node türünde htmlLi elementi ister. Bunu anla.
  }
}
...
function createListItem(item) {
  ...
  input.addEventListener("change", toggleCopmleted);
...
function removeItem(e) {
  ...
  shoppingList.removeChild(a);
  saveToLS();
  displayAlert();
}

function toggleCopmleted(e) {
